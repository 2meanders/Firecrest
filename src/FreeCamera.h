...
public:
    struct MouseSensitivity {
        ...
        MouseSensitivity(float sensitivity) : pan(sensitivity), tilt(sensitivity) {}
...
public:
    ...
    virtual void handleInput(const Input& input, const Window& window,
                             time::Duration delta) override;
